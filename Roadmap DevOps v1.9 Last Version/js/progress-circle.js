    ...
    .then(data => {
        ...
        var interval = setInterval (() => {
            if (!animation) {
                ...
                circle.style.background = "conic-gradient(#9ec5fe50 "+ startValue * 3.6 +"deg, #ffffff 0deg)";
        ...
        for (let i = 1; i <= data.categoryCount; i++) {
            ...
            categoryCircle.style.background = "conic-gradient(#9ec5fe50 "+ categoryPercentage * 3.6 +"deg, #ffffff 0deg)";
        }
    });
});
